...
const AdminHome = () => {
    ...
    return (
        <div className="w-full m-4">
            <h2 className="text-3xl font-extrabold font-mono">Hi, {user.displayName}</h2>

            <div className=" flex gap-5 lg:w-10/12 mx-auto pt-10">

                <div className="stat border rounded-xl bg-white shadow-lg">
